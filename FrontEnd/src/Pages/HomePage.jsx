...
import  AiFeature  from '../Pages/User/AiFeature';
...
function HomePage() {
  ...
  const GetStartedProtectedRote = async () => {
    ...
    return (
      <div className="html">
        <section className="pt-35  md:pt-30 bg-gradient-to-br from-green-50 via-blue-50 to-purple-100 section lg:h-[100vh] md:h-[100vh]">
          <div className="container mx-auto px-10 pt-4 lg:flex">
            <div className="text-center lg:text-left lg:w-1/2">
              ...
              >
                Organize your life effortlessly with our To Do app—where
                productivity meets simplicity, helping you turn plans into
                achievements every day.
              </p>
              <p className="mt-8 md:mt-12">
                <button
                   onClick={GetStartedProtectedRote}
                    data-aos="fade-right"
                    type="button"
            ...
            <div data-aos="flip-left" className="lg:w-1/2 mb-3">
              <svg
                data-name="Layer 1"
        ...
        <section
          id="skills"
          className="flex h-[100vh] items-center bg-gradient-to-r from-blue-50 via-green-50 to-purple-100 section"
        >
          <div className="container mx-auto px-6 align-middle ">
            <h3
              data-aos="fade-down"
              className="pb-10 text-4xl font-bold mb-10 text-center text-blue-900 font-['Rufina'] drop-shadow"
            >
              App Feature
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div
                data-aos="zoom-in-right"
                className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 border border-blue-100"
              >
                <svg
                ...
                <h4 className="font-bold text-xl text-blue-700">
                  Adding Unlimited Works{" "}
                </h4>
                <p className="mt-2 text-gray-500 text-sm">
                  Effortlessly add and manage an unlimited number of tasks to
                  keep your productivity on track every day.
                </p>
              </div>
              <div
                data-aos="zoom-in-up"
              ...
              >
                ...
                <p className="mt-2 text-gray-500 text-sm">
                  {" "}
                  Instantly access and update any task from anywhere in your
                  list, ensuring maximum flexibility and control.
                </p>
              </div>
              <div
                data-aos="zoom-in-up"
              ...
              >
                ...
                <p className="mt-2 text-gray-500 text-sm">
                  Enjoy a seamless experience across all devices with a layout
                  that adapts beautifully to any screen size.
                </p>
              </div>
              <div
              ...
              >
                <svg
                  className="w-10 h-10 mb-4 text-yellow-700"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
                ...
                <p className="mt-2 text-gray-500 text-sm">
                  Your data is protected with robust security measures, ensuring
                  privacy and peace of mind for every user.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="contact"
          className="section h-[100vh] py-20 bg-gradient-to-br from-blue-50 via-green-50 to-purple-100"
        >
          <h3
            data-aos="fade-up"
            className="pt-10 text-4xl font-bold mb-10 text-center text-blue-900 font-[Rufina] drop-shadow"
          >
            Featrue For Users
          </h3>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-20 px-10">
            <div
              data-aos="zoom-in-right"
              className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 border border-blue-100"
            >
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M12 14c3.866 0 7-3.134 7-7S15.866 0 12 0 5 3.134 5 7s3.134 7 7 7zm0 2c-4.418 0-8 2.239-8 5v1h16v-1c0-2.761-3.582-5-8-5z"
                />
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M19.5 9c0-1.5-.5-2.5-1.5-3s-2-.5-3 .5-1 2.5 0 3.5 2.5 1 3.5.5 1.5-1.5 1.5-2.5z"
                />
              </svg>
              <h4 className="font-bold text-xl text-blue-700">
                User Personalization with AI
              </h4>
              <p className="mt-2 text-gray-500 text-sm">
                Use AI to personalize content or layout based on user behavior
                or preferences
              </p>
            </div>
            <div
            ...
            >
              <svg
                className="w-10 h-10 mb-4  text-green-700"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                viewBox="0 0 24 24"
              ...
              <p className="mt-2 text-gray-500 text-sm">
                {" "}
                Allow users to easily share content from your website on social
                media platforms or via direct link.
              </p>
            </div>
            <div
              data-aos="zoom-in-up"
            ...
            >
              <svg
                className="w-10 h-10 mb-4 text-purple-700"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                viewBox="0 0 24 24"
              ...
              <p className="mt-2 text-gray-500 text-sm">
                Let users create accounts, save preferences, and access a
            ...
            >
              ...
              >
                ...
                <line x1="4" y1="4" x2="10" y2="4" strokeLinecap="round" />
                <circle cx="7" cy="4" r="1.5" fill="currentColor" />

                <line x1="4" y1="10" x2="10" y2="10" strokeLinecap="round" />
              ...
              <h4 className="font-bold text-xl text-yellow-700">
                Advanced Search with Filters
              </h4>
              <p className="mt-2 text-gray-500 text-sm">
                Enable users to search and filter content dynamically, with
                real-time updates.
              </p>
            </div>
          </div>
