...
function HomePage() {
    return (
        <div className='html'>
            <section className="pt-35  md:pt-30 bg-gradient-to-br from-green-50 via-blue-50 to-purple-100 section lg:h-[100vh] md:h-[100vh]">
                <div className="container mx-auto px-10 pt-4 lg:flex">
                    <div className="text-center lg:text-left lg:w-1/2">
                    <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                        Elevate Your Day with To Do App
                    </h1>
                    <p className="text-xl lg:text-2xl mt-6 font-light">
                        Organize your life effortlessly with our To Do app—where productivity meets simplicity, helping you turn plans into achievements every day.
                    </p>
                    <p className="mt-8 md:mt-12">
                         <a href="/AccountLogin"> 
                            <button
                            type="button"
                            className="py-4 px-12 mt-3 ml-3  bg-blue-500 hover:bg-blue-700 font-bold rounded text-white"
                            >
                            Get Started
                            </button>
                        </a>
            ...
            <section id='about' className="py-12 section">
            <div className="flex flex-col lg:flex-row max-w-[1440px] justify-between gap-6 mx-10 ">
                <div className="w-full lg:w-[649px] h-[632px] flex flex-col items-center justify-center">
                ...
                <p className="mt-5 mb-12 text-[#267d49] text-2xl font-medium font-['Poppins'] leading-[50px]">
                    Explore my portfolio to discover a collection of innovative web and mobile applications, crafted with passion and precision. Each project reflects my commitment to elegant design, robust functionality, and seamless user experiences.
                </p>
                <button
                    type="button"
                    onClick={() => window.location.href='https://abirullah.github.io/Portfolio-with-react/'}
                    className="px-16 py-5 text-white text-xl font-medium font-['Poppins'] uppercase bg-blue-900 rounded-[3px] shadow-[6px_33px_59px_0px_rgba(0,0,0,0.30)]"
                >
                    Contact Me
                </button>
                </div>
                <img
                className="w-full lg:w-[570px] h-[600px] lg:mt-7 min-h-[600px] object-cover md:m-0 md:w-[full] rounded-2xl shadow-[6px_33px_59px_0px_rgba(0,0,0,0.30)] mt-8 "
                src="https://media.licdn.com/dms/image/v2/D4E03AQHGpVC44leEkQ/profile-displayphoto-shrink_400_400/B4EZbXldBGHcAk-/0/1747373643252?e=2147483647&v=beta&t=h2FDPwN-nB8sF_mjW5HE3ltp6TUWLwdv9mh1ljtN-yM"
                alt=""
                />
            </div>
            </section>
            ...
            <section  className="py-20 bg-gradient-to-br from-green-50 via-blue-50 to-purple-100 section">
                
            <div className="container mx-auto px-6 flex flex-col md:flex-row items-center md:space-x-12 space-y-8 md:space-y-0">
                <div className="flex">
                    <h3 className="justify-center text-4xl font-bold mb-6 text-blue-900 font-['Rufina'] drop-shadow">
                    About Me
                </h3>
                </div>
                ...
                <img
                    src="https://media.licdn.com/dms/image/v2/D4E03AQHGpVC44leEkQ/profile-displayphoto-shrink_400_400/B4EZbXldBGHcAk-/0/1747373643252?e=2147483647&v=beta&t=h2FDPwN-nB8sF_mjW5HE3ltp6TUWLwdv9mh1ljtN-yM"
                    alt="Profile"
                    className="w-40 h-40 md:w-56 md:h-56 rounded-full shadow-lg border-4 border-blue-300 object-cover"
                />
                </div>
                <div className="flex-1">
                
                <p className="text-lg md:text-xl text-gray-700 leading-relaxed bg-white/70 p-6 rounded-xl shadow-md border border-blue-100">
                    With <span className="font-bold text-blue-700">9+ years</span> of experience, I specialize in building high-performance
                    mobile and web applications using <span className="font-semibold text-green-700">React Native</span>, <span className="font-semibold text-blue-700">React.js</span>, and modern web
                    technologies. I excel at creating scalable, user-friendly solutions for
                    <span className="font-semibold text-purple-700"> healthcare</span>, <span className="font-semibold text-pink-700">e-commerce</span>, and <span className="font-semibold text-yellow-700">educational platforms</span>.
                </p>
                </div>
            </div>
            </section>

            <section id="skills" className="py-20 bg-gradient-to-r from-blue-50 via-green-50 to-purple-100 section">
            <div className="container mx-auto px-6">
                <h3 className="text-4xl font-bold mb-10 text-center text-blue-900 font-['Rufina'] drop-shadow">
                App Feature
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 border border-blue-100">
                    <svg className="w-10 h-10 mb-4 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path d="M12 2v20m10-10H2" />
                    </svg>
                    <h4 className="font-bold text-xl text-blue-700">Adding Unlimited Works </h4>
                    <p className="mt-2 text-gray-500 text-sm">Effortlessly add and manage an unlimited number of tasks to keep your productivity on track every day.</p>
                </div>
                <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 border border-blue-100">
                    <svg className="w-10 h-10 mb-4 text-green-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10" />
                    </svg>
                    <h4 className="font-bold text-xl text-green-700">Random Access</h4>
                    <p className="mt-2 text-gray-500 text-sm"> Instantly access and update any task from anywhere in your list, ensuring maximum flexibility and control.</p>
                </div>
                <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 border border-blue-100">
                    <svg className="w-10 h-10 mb-4 text-purple-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <rect x="4" y="4" width="16" height="16" rx="2" />
                    </svg>
                    <h4 className="font-bold text-xl text-purple-700">Responsive Design  </h4>
                    <p className="mt-2 text-gray-500 text-sm">Enjoy a seamless experience across all devices with a layout that adapts beautifully to any screen size.</p>
                </div>
                <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 border border-blue-100">
                    <svg className="w-10 h-10 mb-4 text-yellow-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path d="M3 12h18M12 3v18" />
                    </svg>
                    <h4 className="font-bold text-xl text-yellow-700">Security</h4>
                    <p className="mt-2 text-gray-500 text-sm">Your data is protected with robust security measures, ensuring privacy and peace of mind for every user.</p>
                </div>
                </div>
            </div>
            </section>
            ...
            <section id="contact" className="section py-20 bg-gradient-to-br from-blue-50 via-green-50 to-purple-100">
            <div className="container mx-auto px-6">
                <h3 className="text-4xl font-bold mb-10 text-center text-blue-900 font-['Rufina'] drop-shadow">
                Contact Me
                </h3>
                <form
                action="https://portfolio-ayyam.vercel.app/"
                method="POST"
                className="bg-white p-8 rounded-2xl shadow-lg max-w-xl mx-auto border border-blue-100"
                >
                <div className="mb-6">
                    ...
                    id="name"
                    name="name"
                    className="w-full border-gray-200 border-1 rounded px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-200"
                    required
                    />
                </div>
                <div className="mb-6">
                ...
                <div className="mb-6">
                    <label htmlFor="message" className="block font-bold mb-2 text-blue-700">
                    Message
                    </label>
                    <textarea
                    id="message"
                ...
                <button
                    type="submit"
                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-8 py-3 rounded shadow transition duration-300 w-full"
                >
                    Send
                </button>
                </form>
