          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="mt-2 text-gray-500 text-sm">
                Effortlessly add and manage an unlimited number of tasks to keep
                your productivity on track every day.
              </p>
            </div>
            <div
              data-aos="zoom-in-up"
            ...
            >
              ...
              <p className="mt-2 text-gray-500 text-sm">
                {" "}
                Instantly access and update any task from anywhere in your list,
                ensuring maximum flexibility and control.
              </p>
            </div>
            <div
              data-aos="zoom-in-up"
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-20 px-10">
          ...
          >
            ...
            <p className="mt-2 text-gray-500 text-sm">
              Use AI to personalize content or layout based on user behavior or
              preferences
            </p>
          </div>
          <div
